...
{
    public abstract class ClinicNBWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ClinicNBWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ClinicNBWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ClinicNBDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ClinicNBDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ClinicNBDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ClinicNBDbContext, Task<T>> func)
        {
            T result;
