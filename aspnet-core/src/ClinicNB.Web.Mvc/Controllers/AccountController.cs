...
using ClinicNB.Sessions;
using ClinicNB.Web.Models.Account;
using ClinicNB.Web.Views.Shared.Components.TenantChange;

namespace ClinicNB.Web.Controllers
{
    public class AccountController : ClinicNBControllerBase
    {
